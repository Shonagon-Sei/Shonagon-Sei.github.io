...
function typeSet() {
  ...
  var vClan = document.getElementById('vcl');
  var vClanLabel = document.getElementById('vcll');
  ...
  vClan.addEventListener('change', update);
  ...
  function update() {
    ...
    vClan.style.display = 'none'
    vClanLabel.style.display = 'none'
    var tri = "";
    var tri1 = "";
    ...
    if (select1 === "tu") {
      ...
      if (vClan.value == 'neo' || vClan.value == 'mcl' || vClan.value == 'grn'  ) {
        image.src = "assets/Zoo Trigger Unit Base.png"
        return
      }
    }
    else if (select1 === 'nu') {
    ...
    else if (select1 !== 'vnu' && select1 !== 'vtu')
    {
